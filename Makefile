...
#    Updated: 2023/02/07 17:20:01 by ychahbi          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_CHEK = checker.c extra/check_errors.c extra/ft_atoi.c extra/ft_isdigit.c extra/ft_putchar.c extra/ft_putstr.c extra/ft_split.c extra/ft_strdup.c extra/ft_strjoin.c extra/ft_strlen.c extra/ft_substr.c extra/swap.c extra/push.c extra/rotate.c extra/reverse.c extra/ft_calloc.c extra/ft_bzero.c extra/ft_memset.c  extra/is_sorted_a.c checker/checker_u.c checker/get_next_line.c checker/get_next_line_utils.c checker/ft_strncmp.c 
CC=cc
